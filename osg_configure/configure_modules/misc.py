...
# pylint: disable-msg=W0613
  ...
  def __configure_cleanup(self):
    ...
    fp = open('/etc/osg/osg-cleanup.conf', 'w')

    fp.write('# This file is automatically generated by osg-configure\n')
    fp.write('# Manual modifications to this file may be overwritten\n')
    fp.write('# Instead, modify /etc/osg/config.d/10-misc.ini\n')
    ...
    fp = open('/etc/cron.d/osg-cleanup', 'w')
    fp.write('%s root [ ! -f /var/lock/subsys/osg-cleanup-cron ] || /usr/sbin/osg-cleanup\n' %
